...
#### Initial Cards
We start by testing the last hypothesis first: we compute the sum of the values of the initial table cards of both players, and count the number of wins of player 1.
